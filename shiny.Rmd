...
**Important:** Be sure to use the `DT::` prefix when calling `dataTableOutput` and `renderDataTable` so that the **DT** versions of these functions are guaranteed to be called, instead of the deprecated Shiny versions.
