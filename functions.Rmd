...
You can apply CSS styles to the table cells in a column according to the values of the cells using the function `formatStyle()`. First we show the syntax of CSS styles, which is a named list of CSS values, with the names being CSS property names:
