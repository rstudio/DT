...
The `tableHeader()` function is a wrapper of `htmltools::tags` to generate a table header or footer. It may be convenient when you want to define a custom [table container](./).
