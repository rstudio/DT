...
You can find more examples about styling cells on [this page](010-style.html). Another R package you may consider for formatting tables is [**formattable**](https://github.com/renkun-ken/formattable); see [#31](https://github.com/rstudio/DT/issues/31) for an example.
