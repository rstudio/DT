                ...
                // If the cell has been initialized but not changed, update
              	if (matrix[rowIdx][colIdx]=="_getHeaders_initialized_") {
	              	...
	              	for(var expand = 1; expand < rowspan; expand++){
	              		...
	              		console.log("spanning to row")
	              		console.log(rowIdx+expand);
	              	}

	              	// colspan, use cellindex instead. colspan will be incorrect for hidden columns (colVis), but cellIndex will correctly find them
					expand = 1;
