...
Please note this example is _experimental_, and may have many rough edges. You may not really need server-side processing at all: client-side DataTables may just suffice.
